...
;GUI
TimersGui := Gui("+AlwaysOnTop +border +minsize50x30 +E0x08040000 +lastfound", "Real Planters (not fake)")
...
TimersGui.Add("Text", "x263 y90 +left +BackgroundTrans", "Transparency")
TimersGui.Add("Text", "x345 y90 w29 h14 +Center")
...
TimersGui.Add("text", "x260 y73 w112 +center +BackgroundTrans vdayOrNight", "Day Detected")
TimersGui.Add("text", "x258 y2 w110 h60 vstatus +center +BackgroundTrans", "Status:")
TimersGui.Add("text", "x265 y13 w104 h56 vpstatus +left +BackgroundTrans", "unknown")

TimersGui.Show("x" TimerX " y" TimerY "w365 h96 NoActivate")
...
ba_AddPlanter(GuiCtrl?, *){
    ...
    UpdateStr("PlanterHarvestFull" addindex, "Full")
